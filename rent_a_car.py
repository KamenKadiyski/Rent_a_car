...
def return_car(car_to_return):
    ...
    while True:
        try:
            ...
            if cars[car_to_return]['status'] != 'Rented' or transactions[car_to_return]['status'] != "Active":
                print(f'The car is not rented!')
                break
            else:
                ...
                while True:
                    try:
                        same_point = input(
                            f"Is the car returned to the same location from which it was rented? Y/N: ").upper()
                            ...
                            while True:
                                try:
                                    ...
                                    if electric_car == 'Y' or electric_car == 'YES':
                                        ...
                                        kwh_needed = int(
                                            input(f"Please enter how many kWh are needed to charge the battery: "))
                ...
                while True:
                    try:
                        ...
                        if damages == 'Y' or damages == 'YES':
                            print(
                                f"Since there is damage to the car through your fault, the deposit will not be refunded!")
